export default function Footer() {
  return (
    <footer className="w-full py-14 pb-28 md:pb-14 flex flex-col items-center gap-4 px-6 text-center border-t border-secondary/15 bg-surface-container-highest bg-rumah-gadang">
